...
public partial class TreasureChest
{
	...
	private void StartIdleShake()
	{
		...
		_idleShakeTween.TweenProperty(_boxBody, "rotation_degrees:z",  ShakeMagnitude, half);
		_idleShakeTween.TweenProperty(_boxBody, "rotation_degrees:z", -ShakeMagnitude, half * 2f);
		_idleShakeTween.TweenProperty(_boxBody, "rotation_degrees:z",  0f,             half);
	...
	private void DoAnticipationShake(System.Action onComplete)
	{
		...
		tween.TweenProperty(_boxBody, "rotation_degrees:z",  ShakeMagnitude, half);
		tween.TweenProperty(_boxBody, "rotation_degrees:z", -ShakeMagnitude, half * 2f);
		tween.TweenProperty(_boxBody, "rotation_degrees:z",  0f,             half);
